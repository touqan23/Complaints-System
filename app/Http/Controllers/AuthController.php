...
class AuthController extends Controller
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        if (isset($validated['serial_number'])) {
            $user = $this->authService->Elogin($validated['serial_number'], $validated['password']/*,$validated['FCM_token']*/);
        } else {
            $user = $this->authService->Clogin($validated['identifier'], $validated['password'], $validated['fcm_token']);
        }
