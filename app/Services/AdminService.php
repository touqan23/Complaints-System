...
class AdminService
{
    ...
    public function __construct(EmployeeRepository $repo , CitizenRepository $citizenRepository)
    {
        $this->repo = $repo;
    ...
    {
        return $this->repo->getAllComplaints();
    }
    ...
    public function updateCitizen($citizen, $data)
    {
        return $this->citizenRepository->updateCitizen($citizen, $data);
    }

    public function deleteCitizen($citizen)
    {
        return $this->citizenRepository->deleteCitizen($citizen);
    }
